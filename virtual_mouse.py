...
def countFingers(image, hand_landmarks, handNo=0):
	...
	if hand_landmarks:
		...
		cv2.line(image, (finger_tip_x,finger_tip_y), (tumb_tip_x,tumb_tip_y), (240,235,250), 2) 
        
		# Draw a CIRCLE on CENTER of the LINE between FINGER TIP and THUMB TIP
		centerx=int((finger_tip_x+tumb_tip_x)/2)
		centery=int((finger_tip_y+tumb_tip_y)/2)
		cv2.circle(image, (centerx,centery), 2, (200,200,200), 2) 
